...
class FloatingAction extends Component {
  ...
  getIcon = () => {
    ...
    return <Image style={{ width: 24, height: 24, tintColor: this.state.active ? "white" : "#B7B7B7" }} source={iconMain} /> ;
  };
  ...
  renderActions() {
    ...
    return (
      <Animated.View style={[actionsStyles, {marginRight: Dimensions.get('screen').width * .2}]} pointerEvents="box-none">

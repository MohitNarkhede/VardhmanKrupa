...
import Ripple from '../../../node_modules/react-native-material-ripple';
import { TextField } from '../../../node_modules/react-native-material-textfield';
...
export default class Dropdown extends PureComponent {
  static defaultProps = {
    ...
    baseColor: 'rgba(0, 0,0,1.0)',
    base:'rgba(0, 0, 0, .38)',
    disabledItemColor: 'rgba(0, 0,255,1.0)',
  ...
  renderAccessory() {
    let { base: backgroundColor } = this.props;
    let triangleStyle = { backgroundColor };

    return (
      <View style={styles.accessory}>
        <View style={styles.triangleContainer}>
          <View style={[styles.triangle, triangleStyle, {backgroundColor:'black'}]} />
        </View>
      </View>
    );
  }

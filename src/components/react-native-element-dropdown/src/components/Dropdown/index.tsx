...
const DropdownComponent = React.forwardRef<any, DropdownProps>(
  (props, currentRef) => {
        ...
        <TouchableWithoutFeedback testID={testID} onPress={showOrClose}>
          <View style={styles.dropdown}>
            ...
            <Text
              style={[
                styles.textItem,
                value !== "" ? {fontFamily: Fonts.Regular, fontSize:14, } : {color: "#606060", fontSize: 14, marginLeft:10, },
                font(),
              ]}
              {...selectedTextProps}
            >
            ...
            {renderRightIcon ? (
              ...
              <Image style={{ height: 12, width: 12, marginHorizontal:5, tintColor: "black" }} resizeMode="contain" source={visible ? require('../../../../../images/arrowtop.png') : require('../../../../../images/arrowdown.png')} />
            )}
              ...
              <TouchableWithoutFeedback onPress={showOrClose}>
                <View
                  style={[
                    ...
                    backgroundColor && { backgroundColor: backgroundColor, width: widthPercentageToDP('32%') },
                    keyboardStyle,
                  ]}
                >
                  <View
    ...
    return (
      <View style={[styles.mainWrap, { minHeight: 48,
      
        marginVertical:8,
        paddingHorizontal: 10,
        // backgroundColor: '#fff',
        
        }]} ref={ref} onLayout={_measure}>
        {_renderDropdown()}
        {_renderModal()}
      </View>
    );

...
const FloatingLabelInput: React.ForwardRefRenderFunction<InputRef, Props> = (
  ...
  customLabelStyles = StyleSheet.flatten([
    {
      fontSizeFocused: cart ? 10 : 12,
      fontSizeBlurred: cart ? 12 : 14,
      colorFocused: '#000000',
      colorBlurred: '#606060',
    },
  ...
  let input: TextStyle =
    inputStyles !== undefined
      ...
      : setGlobalStyles?.inputStyles !== undefined
        ...
        : cart ? styles.input1 :  styles.input;
  ...
  return (
    <TouchableWithoutFeedback style={{ flex: 1, }} onPress={setFocus} onLayout={onLayout}>
      <View style={{ flexDirection: 'column', flexGrow: 1, marginVertical: 8, }}>
        <View style={{ flexDirection: 'row', flexGrow: 1, }}>
          ...
          <View style={[containerStyles, { borderColor: error ? '#FF3B3B' : (isFocusedState ? 'black' : 'gray') }]}>

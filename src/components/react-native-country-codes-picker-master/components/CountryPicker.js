			...
			>
				...
				>
					<TextInput
						...
						{...rest}
					/>
					<TouchableOpacity onPress={()=> close()} style={{padding:5, paddingHorizontal:12}}>
						<Image style={{height:18, width:18}} resizeMode="contain" source={require('../../../images/arrowdown.png')} />
					</TouchableOpacity>
				</View>

...
export default class CartList extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    this.setState({qty: parseInt(this.props.item.quantity), remark: this.props.item.remark})
    }
                ...
                <TouchableOpacity
                    ...
                    <View style={{ flex:1,  flexDirection: 'column',  }}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row',  paddingHorizontal: 10 }}>
                            <Text numberOfLines={1} style={{ flex: 1, fontSize: 12, color: "#000", fontFamily: Fonts.Light, textAlign: 'left', paddingRight: 10 }}>{rowData.category}</Text>
                            <Text numberOfLines={2} style={{ fontSize: 12, color: "#000", paddingLeft:10, fontFamily: Fonts.Light, textAlign: 'left', }}>Weight: {rowData.weight} gm</Text>
                        </View>
                        </View>
                        <TouchableOpacity
                                ...
                                }} style={{ alignItems: 'center', justifyContent: 'center',  width: 25, height: 25, borderRadius: 5, backgroundColor: "#fff" }}>
                                <Image

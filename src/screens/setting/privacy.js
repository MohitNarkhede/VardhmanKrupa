...
export default class Privacy extends React.Component {
    ...
    privacy = async () => {
        ...
        const res = await FetchAPI(API.privacy, "POST", Request);
        console.log(res);
                    ...
                    <SafeAreaView style={{ flex: 1, backgroundColor: "white", }}>
                        ...
                        <Loader loading={this.state.loading} />
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', }}>
                                ...
                                <Text style={{ fontFamily: Fonts.SemiBold, fontSize: FontSize.medium,  color: checkTheme(theme).black }}>{"Privacy Policy"}</Text>
                            </View>

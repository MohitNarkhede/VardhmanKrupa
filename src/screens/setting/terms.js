...
export default class Terms extends React.Component {
    ...
    terms = async () => {
        ...
        const res = await FetchAPI(API.terms, "POST", Request);
        console.log(res);
                    ...
                    <SafeAreaView style={{ flex: 1, backgroundColor: "white", }}>
                        ...
                        <Loader loading={this.state.loading} />
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', }}>
                                ...
                                <Text style={{ fontFamily: Fonts.SemiBold, fontSize: FontSize.medium,  color: checkTheme(theme).black }}>{"Terms & Condition"}</Text>
                            </View>
